<?php
    ...
    //Gets posts from database in order of highers likes minus dislikes.
    ...
    $posts_arr = array();
    $query = "SELECT title, postDate, postID, authorID, content FROM Posts ORDER BY popularity DESC";

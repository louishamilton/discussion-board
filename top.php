<?php
    ...
    //Gets posts from database in order of lowest relevancy score. Relevancy score is calculated in updatePopularity.php.
    ...
    $posts_arr = array();
    $query = "SELECT title, postDate, postID, authorID, content FROM Posts ORDER BY score ASC";
